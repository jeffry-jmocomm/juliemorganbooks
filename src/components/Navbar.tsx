...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a12]/85 backdrop-blur-xl border-b border-white/[0.06] px-6 py-4">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            ...
            <div className="flex items-center gap-4 pl-6 border-l border-white/10">
              <a
                ...
                className="text-slate-500 hover:text-[var(--color-brand-purple-light)] transition-colors duration-300"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="20"
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-[70] md:hidden transition-all duration-500 ease-in-out ${isMenuOpen
      ...
      >
        {/* Backdrop */}
        <div
          className={`absolute inset-0 bg-[#0a0a12]/80 backdrop-blur-3xl transition-opacity duration-500 ${isMenuOpen ? "opacity-100" : "opacity-0"}`}
          onClick={() => setIsMenuOpen(false)}
        />

        {/* Menu Panel */}
        <div
          className={`absolute inset-y-0 right-0 w-full max-w-[320px] bg-[#111120] shadow-2xl border-l border-white/[0.06] transition-transform duration-500 ${isMenuOpen ? "translate-x-0" : "translate-x-full"
            }`}
        >
          <div className="flex flex-col h-full overflow-y-auto">
            ...
            {/* Footer / Socials */}
            <div className="p-8 bg-white/[0.02] border-t border-white/[0.06]">
              ...
              <div className="flex items-center gap-5 mb-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-[var(--color-brand-purple-light)] hover:bg-white/10 transition-all"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width="20"
