  ...
  return (
    <div className="min-h-screen py-32 px-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-12 tracking-tighter text-center gradient-text pb-4">
          About the Author
        </h1>
        ...
        <div className="glass-panel p-8 md:p-12 rounded-3xl grid md:grid-cols-5 gap-12 items-center">
          ...
          {/* Author Bio */}
          <div className="md:col-span-3 space-y-6 text-slate-400 leading-relaxed">
            <p>
            ...
            <div className="pt-6 mt-6 border-t border-white/[0.06]">
              ...
              <div className="flex gap-4 pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-white/5 text-slate-400 rounded-full hover:bg-[var(--color-brand-purple)] hover:text-white transition-colors"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width="18"
                ...
                <a
                  ...
                  className="p-2 bg-white/5 text-slate-400 rounded-full hover:bg-white hover:text-[#0a0a12] transition-colors"
                >
                  <Mail size={18} />
                </a>
              </div>
          ...
          <div className="md:col-span-5 pt-10 mt-2 flex justify-center">
            <img
              ...
              className="w-full max-w-2xl h-auto object-contain opacity-50 hover:opacity-80 transition-opacity duration-500"
            />
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center px-8 py-3 bg-white/5 hover:bg-[var(--color-brand-purple)] border border-white/10 hover:border-[var(--color-brand-purple)] text-white/80 hover:text-white rounded-full font-medium transition-all duration-300"
          >
            Explore Her Books
          </Link>
        </div>
